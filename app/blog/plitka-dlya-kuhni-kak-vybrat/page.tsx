...
export const metadata: Metadata = {
  title: "Плитка для кухни: как выбрать фартук и пол | LINCER СПб",
  ...
  openGraph: { title: "Плитка для кухни: как выбрать фартук и пол", url: `${SITE_URL}/blog/plitka-dlya-kuhni-kak-vybrat`, siteName: "LINCER", locale: "ru_RU", type: "article" },
}
        ...
        <div className="mx-auto max-w-7xl px-4 py-3">
          <nav className="flex items-center gap-1.5 text-sm text-muted-foreground">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link href="/plitka-belaya-spb" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-border bg-background hover:border-primary/40 hover:bg-accent transition-all text-sm text-foreground font-medium">Белая плитка</Link>
            </div>
          </div>
