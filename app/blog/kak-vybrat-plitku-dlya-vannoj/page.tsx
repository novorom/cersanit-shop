...
export const metadata: Metadata = {
  title: "Как выбрать плитку для ванной комнаты — полный гид 2025 | LINCER СПб",
  ...
  openGraph: { title: "Как выбрать плитку для ванной — полный гид", url: `${SITE_URL}/blog/kak-vybrat-plitku-dlya-vannoj`, siteName: "LINCER", locale: "ru_RU", type: "article" },
}
            ...
            <div className="flex flex-col gap-2">
              ...
              <section className="mt-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                  ...
                  <Link href="/catalog/plitka-calacatta-belyy-30x60-glyantsevaya" className="group flex flex-col bg-card rounded-xl border border-border overflow-hidden hover:shadow-md hover:border-primary/30 transition-all"><div className="relative aspect-square overflow-hidden bg-muted"><img src="https://images.weserv.nl/?url=https://pvi.lincer.ru/upload/uf/c2b/KTL052.jpg&w=300&output=webp&q=80" alt="Плитка Calacatta белый рельеф 30x60" className="w-full h-full object-cover" loading="lazy" /></div><div className="p-3"><span className="text-xs text-muted-foreground line-clamp-2">Плитка Calacatta белый рельеф 30x60</span><span className="mt-2 block text-base font-bold text-foreground">795 ₽/м²</span></div></Link>
