...
export const metadata: Metadata = {
  title: "Керамогранит под дерево или ламинат — что лучше для пола? | LINCER СПб",
  ...
  openGraph: { title: "Керамогранит под дерево или ламинат — что лучше?", url: `${SITE_URL}/blog/keramogranit-ili-laminat`, siteName: "LINCER", locale: "ru_RU", type: "article" },
}
