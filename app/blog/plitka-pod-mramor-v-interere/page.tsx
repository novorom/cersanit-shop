    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-10 mb-4">Применение в различных зонах дома</h2>
            <p>Керамогранит мрамор идеален для кухни, где требуется практичность и эстетика одновременно. На фартуке или столешнице мраморная плитка создаёт атмосферу дорогого ресторана. В спальне и гостиной она добавляет шика, не требуя при этом специального ухода, в отличие от натурального мрамора, боящегося влаги и кислот.</p>
            <p>В ванной комнате плитка под мрамор играет роль главного декоративного элемента. Её водостойкие свойства позволяют использовать как на полу, так и при полной облицовке стен. В прихожей и коридоре мраморный керамогранит защищает поверхности от износа, сохраняя первоначальный вид на протяжении десятилетий. Жители Янино и других районов Санкт-Петербурга активно выбирают именно такие решения для обновления интерьеров.</p>
          </section>
