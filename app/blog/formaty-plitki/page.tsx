...
export const metadata: Metadata = {
  title: "Форматы плитки: как выбрать размер для комнаты | LINCER СПб",
  ...
  openGraph: { title: "Форматы плитки: как выбрать размер для комнаты", url: `${SITE_URL}/blog/formaty-plitki`, siteName: "LINCER", locale: "ru_RU", type: "article" },
}
