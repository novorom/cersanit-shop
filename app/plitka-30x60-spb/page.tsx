...
export const metadata: Metadata = {
  title: "Плитка 30x60 Lincer купить в Санкт-Петербурге | LINCER",
  ...
  openGraph: { title: "Плитка 30x60 Lincer в СПб", url: `${SITE_URL}/plitka-30x60-spb`, siteName: "LINCER", locale: "ru_RU", type: "website" },
}
...
export default function FormatPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная","item":"https://lincer.ru"},{"@type":"ListItem","position":2,"name":"Плитка 30x60","item":"https://lincer.ru/plitka-30x60-spb"}]}` }} />
