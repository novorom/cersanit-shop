...
export const metadata: Metadata = {
  title: "Плитка для балкона и лоджии Lincer купить в Санкт-Петербурге | LINCER",
  ...
  openGraph: { title: "Плитка для балкона Lincer в СПб", url: `${SITE_URL}/plitka-dlya-balkona-spb`, siteName: "LINCER", locale: "ru_RU", type: "website" },
}
const faq = [
...
export default function PlitkaBalkon() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная","item":"https://lincer.ru"},{"@type":"ListItem","position":2,"name":"Плитка для балкона","item":"https://lincer.ru/plitka-dlya-balkona-spb"}]}` }} />
