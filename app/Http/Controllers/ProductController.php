    ...
    public function index(Request $request): View
    {
        ...
        if (count($selectedCategories) === 1) {
            ...
            if ($cat === 'ceramic-granite') {
                ...
                $seoText = 'Керамическая плитка остается классическим выбором для отделки ванных комнат, санузлов и кухонных фартуков. Она экологична, легко моется и не теряет своего внешнего вида годами. В ассортименте магазина Керамогранит Опт собраны лучшие решения: от минимализма до сложных декоративных элементов и панно.';
            } elseif ($cat === 'step') {
