    ...
    public function index(Request $request): View
    {
        ...
        if (count($selectedCategories) === 1) {
            ...
            if ($cat === 'ceramic-granite') {
                $seoTitle = 'Керамогранит купить в СПб — цены в каталоге ' . $siteName;
                $seoDescription = 'Большой выбор керамогранита в наличии на складе. Оптовые цены, доставка по Санкт-Петербургу и области.';
                $seoH1 = 'Керамогранит';
            } elseif ($cat === 'ceramic-tile' || $cat === 'wall-tile') {
                $seoTitle = 'Керамическая плитка купить — каталог цен ' . $siteName;
                $seoDescription = 'Стильная керамическая плитка в наличии. Коллекции для ванной и кухни. Доставка со склада.';
                $seoH1 = 'Керамическая плитка';
            } elseif ($cat === 'step') {
                $seoTitle = 'Ступени из керамогранита — купить в СПб';
                $seoH1 = 'Ступени';
            }
        }
