...
export const metadata: Metadata = {
  title: "Керамогранит 60x120 Lincer купить в Санкт-Петербурге | LINCER",
  ...
  openGraph: { title: "Керамогранит 60x120 Lincer в СПб", url: `${SITE_URL}/keramogranit-60x120-spb`, siteName: "LINCER", locale: "ru_RU", type: "website" },
}
...
export default function FormatPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная","item":"https://lincer.ru"},{"@type":"ListItem","position":2,"name":"Керамогранит 60x120","item":"https://lincer.ru/keramogranit-60x120-spb"}]}` }} />
