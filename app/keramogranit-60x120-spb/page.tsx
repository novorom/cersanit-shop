...
export default function FormatPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная","item":"https://cersanit-spb.ru"},{"@type":"ListItem","position":2,"name":"Керамогранит 60x120","item":"https://cersanit-spb.ru/keramogranit-60x120-spb"}]}` }} />
