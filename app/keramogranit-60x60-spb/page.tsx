...
export const metadata: Metadata = {
  title: "Керамогранит 60x60 Lincer купить в Санкт-Петербурге | Керамогранит Опт",
  description: "Керамогранит 60x60 см Lincer в СПб. Универсальный формат для пола и стен, огромный выбор коллекций. Склад Янино, доставка от 1 дня.",
  alternates: { canonical: `${SITE_URL}/keramogranit-60x60-spb` },
  openGraph: { title: "Керамогранит 60x60 Lincer в СПб", url: `${SITE_URL}/keramogranit-60x60-spb`, siteName: "Керамогранит Опт", locale: "ru_RU", type: "website" },
}
...
export default function FormatPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Где купить керамогранит 60x60 в СПб?","acceptedAnswer":{"@type":"Answer","text":"Керамогранит 60x60 Lincer в большом ассортименте на складе в Янино. Самовывоз бесплатно, доставка по СПб и ЛО от 1 дня. Телефон: +7 (905) 205-09-00."}},{"@type":"Question","name":"Можно ли укладывать 60x60 на стену?","acceptedAnswer":{"@type":"Answer","text":"Да, формат 60x60 подходит и для пола и для стен. Для стен используйте плиточный клей с хорошей адгезией и наносите его методом двойного нанесения."}},{"@type":"Question","name":"Какой расход клея для плитки 60x60?","acceptedAnswer":{"@type":"Answer","text":"Для формата 60x60 рекомендуется 5–7 кг/м² при методе двойного нанесения — на основание и на плитку. Это обеспечивает 95–100% контакт."}}]}` }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная","item":"https://keramogranit-opt.ru"},{"@type":"ListItem","position":2,"name":"Керамогранит 60x60","item":"https://keramogranit-opt.ru/keramogranit-60x60-spb"}]}` }} />
      ...
      <section className="bg-primary text-primary-foreground py-12 lg:py-16"><div className="mx-auto max-w-7xl px-4"><h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-balance">Керамогранит 60x60 ведущих брендов в Санкт-Петербурге</h1><p className="mt-4 text-primary-foreground/80 text-lg leading-relaxed max-w-3xl">{items.length} позиций в наличии на складе в Янино. Доставка по СПб от 1 дня.</p><div className="mt-8 flex flex-wrap gap-3"><Link href="#products" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-background text-foreground font-medium text-sm hover:bg-background/90 transition-colors">Смотреть товары <ChevronRight className="h-4 w-4" /></Link><a href={`tel:${PHONE_RAW}`} className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-primary-foreground/30 text-primary-foreground font-medium text-sm hover:bg-primary-foreground/10 transition-colors"><Phone className="h-4 w-4" /> {PHONE}</a></div></div></section>
      ...
      <section className="py-12 bg-muted/30">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="rounded-xl border border-border bg-card p-5">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">Керамогранит 60x60 Lincer в большом ассортименте на складе в Янино. Самовывоз бесплатно, доставка по СПб и ЛО от 1 дня. Телефон: +7 (905) 205-09-00.</p>
          </div>
          <div className="rounded-xl border border-border bg-card p-5">
