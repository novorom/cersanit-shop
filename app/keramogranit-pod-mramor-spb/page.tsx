...
export const metadata: Metadata = {
  title: "Керамогранит под мрамор Lincer в СПб — купить со склада | Керамогранит Опт",
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              <Link href="/blog/plitka-pod-mramor-v-interere" className="block p-5 rounded-xl border border-border bg-card hover:border-primary hover:shadow-md transition-all group">
                ...
                <p className="text-sm text-muted-foreground">Идеи и советы по оформлению.</p>
              </Link>
              <Link href="/blog/kak-vybrat-plitku-dlya-vannoj" className="block p-5 rounded-xl border border-border bg-card hover:border-primary hover:shadow-md transition-all group">
                ...
                <p className="text-sm text-muted-foreground">Мраморная плитка для ванной.</p>
              </Link>
              <Link href="/blog/trendy-plitki-2025" className="block p-5 rounded-xl border border-border bg-card hover:border-primary hover:shadow-md transition-all group">
                ...
                <p className="text-sm text-muted-foreground">Актуальные тренды с мрамором.</p>
              </Link>
          </div>
        </div>
      </section>
